...
### Added
- App update flow downloads in background and installs on restart

### Changed
- Update app update toasts and settings UI for silent install flow

### Fixed
- Remove manual update prompt path from update banner
...
[Unreleased]: https://github.com/chiconghvan/DonuScheduler/compare/v0.7.2...HEAD
