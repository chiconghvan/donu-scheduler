...
### Fixed
- Spread first `window_count` schedule run randomly within the window instead of spawning immediately at start time

## [v0.8.2] - 2026-07-15

### Fixed
- Gracefully handle GPMLogin profile verify parse errors by falling back to alternative API endpoints instead of failing immediately

## [v0.8.1] - 2026-07-09

### Fixed
- Verify profiles against their selected manager before launching scheduled jobs or manual test runs
- Skip deleted or missing profiles instead of passing stale profile IDs to the runtime
...
### Fixed
- Script Store update now applies pending install immediately and clears stale pending state

## [v0.7.6] - 2026-07-06

### Fixed
- Parse GPM Global groups response with pagination and load profile group names again

## [v0.7.5] - 2026-07-06

### Fixed
- Sync Cargo.lock package version for release metadata
